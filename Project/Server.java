...
import java.sql.*;
//https://myaccount.google.com/lesssecureapps?pli=1&rapt=AEjHL4PBkmESvEBluuhO1lHafXg_q0xDfSekF4Z44ZffRJFLlVPiqEQyaDJ4aLdOx52m--rH_cut9EjPh45lVt_D0LwppEFStQ
//turn on
    	 ...
    	 host="localhost";  
		   ...
		   props.put("mail.smtp.ssl.protocols", "TLSv1.2");
			...
			try {
	            ...
	            message2.setFrom(new InternetAddress("124003317@sastra.ac.in"));
  ...
  /* private void loginChat() throws IOException
    ...
    */
    private void Components() {
    		...
    		lblNewLabel.setIcon(new ImageIcon("E:\\SASTRA\\5th Semester\\Computer Networks\\CN_Project\\Images\\server5.jpg"));
